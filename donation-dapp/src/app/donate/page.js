      ...
      <div className="min-h-screen bg-black">
        ...
        {!isConnected && (
          <div className="flex flex-col">
            <p className="text-white text-center absolute top-1/2 left-1/2 font-semibold transform -translate-x-1/2 -translate-y-1/2 mb-4">
              Please connect an Ethereum wallet to view campaigns
            </p>
            <Image
              src="/loading.gif"
              alt="loading"
              width={30}
              height={30}
              className="absolute w-30 h-30 top-2/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
            />
          </div>
        )}
              ...
              <div className="px-6 py-4">
                ...
                <div className="mb-6 flex flex-row justify-between items-center">
                  <div>
                    ...
                    <p className="text-[#747474] text-[14px]">
                      Raised of {ethers.formatEther(campaign.targetAmount)} ETH
                    </p>
                  </div>
