...
export default function DetailsPage() {
  ...
  useEffect(() => {
    if (campaigns && Array.isArray(campaigns)) {
      ...
      const selectedCampaign = campaigns.find((c) => c.id?.toString() === id);
    ...
    return (
      <div className="min-h-screen w-full bg-black">
        <Image
          ...
          width={30}
          height={30}
          className="bg-black absolute w-45 h-45 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
        />
      </div>
    );
              ...
              <div>
                {campaign.imageUrl ? (
                  <img
                    ...
                    className="object-cover rounded-xl w-[65vw] h-[400px]"
                  />
                ) : (
              ...
              <div className="flex flex-col justify-between text-center">
                <div className="w-28 aspect-square">
                  ...
                  daysLeft(campaign.targetDate) < 0 ? (
                    <div className="bg-[#0E0E0E] text-white mb-0 h-[60%] flex justify-center items-center px-4 py-4 font-bold text-2xl rounded-t-xl">
                      --
                    </div>
                  ) : (
                    <div className="bg-[#0E0E0E] text-white mb-0 h-[60%] flex justify-center items-center px-4 py-4 font-bold text-2xl rounded-t-xl">
                      {daysLeft(campaign.targetDate)}
                    </div>
                  )}
                  <div className="bg-[#1E1E1E] text-sm text-[#747474] font-semibold w-full h-[40%] flex justify-center items-center rounded-b-xl">
                    Days left
                  </div>
                </div>
                <div className=" w-28 aspect-square">
                  ...
                  <div className="bg-[#1E1E1E] text-sm text-[#747474] font-semibold w-full h-[40%] flex justify-center items-center rounded-b-xl">{`Raised of ${ethers.formatEther(
            ...
            <div className="flex flex-col lg:mr-5">
              <div className="flex flex-col">
                ...
                <div className="flex flex-row">
                  ...
                  <div className="text-[#747474] text-sm flex flex-wrap">
                        ...
                        donationEvents.map((event, index) => {
                          ...
                          return (
                            <div
                              ...
                              className="flex flex-row w-full justify-between py-4 last-of-type:border-b-0 border-b border-[#1E1E1E] text-[#747474]"
                            >
                              <div className="w-[20%] text-left">
                                {index + 1}
                              </div>
                              <div className="w-[80%] text-left">
                                {truncateAddress(donor)}
                              </div>
              ...
              {totalSeconds > 0 ? (
                <div className="flex flex-col mt-10">
                  <h1 className="text-white font-bold mb-4 text-lg">
                    TIME LEFT
                  </h1>
              ...
              {isAdmin && (
                <div className="flex flex-col mt-10">
                  ...
                  <div className="bg-[var(--dark-gray)] whitespace-nowrap md:w-[25vw] text border-[1px] px-6 py-3 border-[#747474] text-blue-500 cursor-pointer underline underline-offset-3 font-semibold">
                    <Link
                      href={`https://maroon-high-horse-665.mypinata.cloud/ipfs/${campaign.milestoneIPFSHash}`}
                    >
                      View Document
                    </Link>
                  </div>
            ...
            {isReleaseModalOpen && (
              <div className="fixed inset-0 bg-black/50 bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-[#0E0E0E] p-8 rounded-xl max-w-md w-full mx-4">
                  ...
                  <p className="text-[#747474] mb-6">
                    Releasing {ethers.formatEther(campaign.raisedAmount)} ETH to{" "}
                    {campaign.name}...
                  </p>
                  <div className="flex justify-end gap-4">
                    <button
            ...
            <div className="lg:mt-0 mt-8">
              ...
              {!campaign.approved && campaign.status === 0 ? (
                <div className="px-8 py-12 flex text-[#747474] bg-[#0E0E0E] rounded-xl justify-center items-center w-full lg:w-[25vw] gap-10">
                  This campaign cannot be funded yet because it is yet to be
                  approved.
                </div>
              ) : !campaign.approved && campaign.status === 2 ? (
                <div className="px-8 py-12 flex text-[#747474] bg-[#0E0E0E] rounded-xl justify-center items-center w-full lg:w-[25vw] gap-10">
                  This campaign cannot be funded because the campaign has been
                  rejected.
                </div>
              ) : Number(campaign.targetDate) <=
                  Math.floor(Date.now() / 1000) && !campaign.fundsReleased ? (
                <div className="px-8 py-12 flex text-[#747474] bg-[#0E0E0E] rounded-xl justify-center items-center w-full lg:w-[25vw] gap-10">
              ...
              ) : campaign.organization.toLowerCase() ===
                address?.toLowerCase() ? (
                <div className="px-8 py-12 flex text-[#747474] bg-[#0E0E0E] rounded-xl justify-center items-center w-full lg:w-[25vw] gap-10">
                ...
                <form
                  ...
                  className="px-8 py-12 flex flex-col bg-[#0E0E0E] rounded-xl justify-center items-center w-full lg:w-[25vw] gap-10"
                >
                  <p className="text-[#747474] text-sm">
                    Enter the amount that you would want to support this
                    campaign with
                  </p>
                  <input
                    type="number"
                  ...
                  <button
                    type="submit"
                    className="w-full font-bold rounded-2xl bg-[var(--sblue)] text-black p-3 text-lg font bold cursor-pointer hover:bg-[var(--bold-blue)]"
                  >
                    Donate
                  </button>
                </form>
