  ...
  useEffect(() => {
    async function fetchDonations() {
      ...
      try {
        ...
        const userDonations = events.filter(
        ...
        const sortedDonations = donationsWithDetails.sort(
        ...
        <div className="bg-black md:bg-[var(--dark-gray)] w-full md:w-[85%] pt-14 md:mt-16 flex flex-col mx-auto rounded-xl">
          <div className="flex flex-col px-10 md:px-14">
            ...
            <p className="text-[#747474] text-[16px] font-semibold mt-4 md:mt-2">
              Every donation you make will be recorded here
            </p>
          </div>
            ...
            <div className="min-w-[800px]">
              ...
              {loading ? (
                ...
                filteredDonations.map((donation, index) => (
                  <div
                    key={index}
                    className="flex flex-row justify-between text-sm border-b border-[#1E1E1E] last-of-type:border-b-0 last-of-type:rounded-b-xl text-white px-10 lg:px-14 py-6 font-bold hover:bg-[#0E0E0E] whitespace-nowrap"
                  >
                    ...
                    <div className="min-w-[100px] text-center text-[#747474] whitespace-nowrap">
                      {donation.amount} ETH
                    </div>
                    ...
                    <div className="min-w-[100px] text-center">
                      ...
                      >
                        <svg
                          className="mx-auto border-b-[0.5px] border-blue-500"
                          xmlns="http://www.w3.org/2000/svg"
                          height="20"
                          width="20"
                          viewBox="0 0 576 512"
