    ...
    <>
      <div className="min-h-screen bg-black md:pb-20">
        ...
        <div className=" justify-center md:mx-auto md:mt-18 h-auto md:bg-[#0E0E0E] w-full md:w-[80%] px-10 md:px-20 lg:px-28 py-16 rounded-3xl">
          <h1 className="text-white md:text-center font-bold text-2xl md:text-xl mb-7">
            Create a Campaign
          </h1>
          ...
          <form action="" method="" onSubmit={handleSubmit}>
            ...
            <div className="w-full relative">
              ...
              <div className="realtive">
                ...
                <div className="absolute inset-0 px-6 py-3 flex items-center pointer-events-none">
                  <span
                    className={`text-[18px] font-light mt-9 ${
            ...
            <p className="text-[#747474] mt-3 font-semibold">
              Please ensure to add contact details in your milestone document
            </p>

            <button
              type="submit"
              className="bg-[var(--sblue)] text-black py-4 px-6 font-bold text-lg rounded-lg md:rounded-2xl hover:bg-[var(--light-blue)] cursor-pointer block mx-auto mt-10 md:mt-16"
            >
