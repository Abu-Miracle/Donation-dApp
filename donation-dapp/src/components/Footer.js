    ...
    <footer className="bg-[#0E0E0E] text-[#B0B0B0] py-12">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div>
          ...
          <p className="text-sm">
            A transparent, blockchain-powered donation platform connecting
            causes and contributors worldwide.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/">
                <p className="hover:text-white hover:underline text-sm">Home</p>
              </Link>
            </li>
            <li>
              <Link href="#about">
                <p className="hover:text-white hover:underline text-sm">
                  About Us
                </p>
              </Link>
            </li>
        ...
        <div>
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <p className="hover:text-white text-sm">+234 912 959 8415</p>
              </li>
              <li>
                <p className="hover:text-white text-sm">+234 909 692 9074</p>
              </li>
            </ul>
          </div>
        ...
        <div>
          ...
          <div className="flex space-x-4">
            ...
            <a
              href="https://instagram.com/__abu_m_"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-white"
            >
            ...
            <a
              href="https://github.com/Abu-Miracle/Donation-dApp"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-white"
            >
