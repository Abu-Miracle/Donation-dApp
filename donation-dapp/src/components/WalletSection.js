    ...
    <div className="bg-gray-200 text-white py-10 px-10 md:px-20">
      <div className="mx-auto text-center text-black">
        <h2 className="text-3xl font-bold mb-2">
          Create Your Wallet to Join the Movement
        </h2>
        <h2 className="text-lg font-medium mb-8">
          A secure Ethereum wallet is essential to fully interact with our
          platform
        </h2>
        ...
        <div className="w-full flex md:flex-row flex-col justify-center bg-gray-300 rounded-2xl">
          ...
          <div className="px-5 py-10 md:px-10 w-full md:w-[50%] text-justify gap-1 flex flex-col relative z-10">
            ...
            <p className="mb-2">
              Ethereum wallets hold your private keys and sign transactions,
              enabling you to safely call smart contracts and manage tokens
              without exposing sensitive data
            </p>
            <h2 className="font-semibold text-[18px]">
              Why we recommend Metamask
            </h2>
            <p>
              We recommend MetaMask because it balances ease of use for
              newcomers with advanced settings for experienced users
            </p>
            <p>
              MetaMask is the most widely adopted browser extension and mobile
              wallet for Ethereum, with over 21 million monthly active users and
              seamless integration with thousands of dApps.
            </p>
