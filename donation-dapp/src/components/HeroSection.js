    ...
    <div className="min-h-screen bg-[url('/background.svg')] bg-cover bg-center bg-fixed">
      <div className="min-h-screen bg-black/65 flex flex-col">
        ...
        <div className='my-auto h-full flex flex-col items-center justify-center text-center px-4 py-10'>
          <div className="px-3">
            <p className='text-[42px] lg:text-[60px] font-bold text-white leading-[1.1] mb-0 transition-transform duration-300 hover:scale-105'>Empowering Donations with 
            <span className="block mt-3 lg:mt-2">Trust and Transparency</span></p>
            <p className="text-2xl flex-wrap lg:text-[40px] font-bold text-[var(--sblue)] mt-8 transition-transform duration-300 hover:scale-105">Powered by The Ethereum Blockchain</p>
            <p className='text-xl lg:text-[30px] font-light text-[#E9ECEB] mt-8 transition-transform duration-300 hover:scale-105'>Be a part of the breakthrough and make someone’s dream come true.</p>
          </div>
